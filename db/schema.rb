...
ActiveRecord::Schema.define(version: 20141010093954) do
  ...
  create_table "poverty_indicators", force: true do |t|
    ...
    t.integer "clave_mun"
    t.string  "nom_mun"
    t.decimal "pobtot_ajustada",        precision: 10, scale: 0
    ...
    t.integer "rankin_p"
    t.integer "rankin_pe"
    t.decimal "N_pobreza",              precision: 10, scale: 0
    t.decimal "N_pobreza_e",            precision: 10, scale: 0
    t.decimal "N_pobreza_m",            precision: 10, scale: 0
    t.decimal "N_vul_car",              precision: 10, scale: 0
    t.decimal "N_vul_ing",              precision: 10, scale: 0
    t.decimal "N_npnv",                 precision: 10, scale: 0
    t.decimal "N_ic_rezedu",            precision: 10, scale: 0
    t.decimal "N_ic_asalud",            precision: 10, scale: 0
    t.decimal "N_ic_segsoc",            precision: 10, scale: 0
    t.decimal "N_ic_cv",                precision: 10, scale: 0
    t.decimal "N_ic_sbv",               precision: 10, scale: 0
    t.decimal "N_ic_ali",               precision: 10, scale: 0
    t.decimal "N_carencias",            precision: 10, scale: 0
    t.decimal "N_carencias3",           precision: 10, scale: 0
    t.decimal "N_plb",                  precision: 10, scale: 0
    t.decimal "N_plb_m",                precision: 10, scale: 0
    ...
    t.decimal "pobtot_00",              precision: 10, scale: 0
    t.decimal "pobtot_05",              precision: 10, scale: 0
    t.decimal "pobtot_10",              precision: 10, scale: 0
